            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="alert alert-warning" role="alert">
                        <strong>You are on the page to create a new user, Be careful!!! <a target="_blank" href="#"> See the manual</a>
                        ...
                        <div class="body">
                            <form id="product-form" class="form-horizontal" method="post" action="admin.php?controller=user&action=add" enctype="multipart/form-data" role="form">
                                ...
                                <div class="row clearfix">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <input name="password" type="text" maxlength="50" value="<?php echo $user_info ? $user_info['user_password'] : ''; ?>" class="form-control" id="name" placeholder="Enter first..." required="" />
                                        </div>
                                    </div>
                                </div>
                                <h2 class="card-inside-title" style="font-weight:bold;">User name and surname:</h2>
                                <div class="row clearfix">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <input name="name" type="text" maxlength="255" value="<?php echo $user_info ? $user_info['user_name'] : ''; ?>" class="form-control" id="name" placeholder="real name and surname..." required="" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <input name="email" type="email" maxlength="255" value="<?php echo $user_info ? $user_info['user_email'] : ''; ?>" class="form-control" id="color" placeholder="Enter your email..." required="" />
                                        </div>
                                    </div>
                                </div>
                                <h2 class="card-inside-title" style="font-weight:bold;">Select the level of administrative rights (Role):</h2>
                                <div class="row clearfix">
                                ...
                                <div class="row clearfix">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <input name="address" type="text" maxlength="200" value="<?php echo $user_info ? $user_info['user_address'] : ''; ?>" class="form-control" id="material" placeholder="User address..." required="" />
                                        </div>
                                    </div>
                                </div>
                                <h2 class="card-inside-title" style="font-weight:bold;">Enter your phone number:</h2>
                                <div class="row clearfix">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                ...
                                <h2 class="card-inside-title" style="font-weight:bold;">Select a new member creation date (required):</h2>
                                <div class="row clearfix">
                                    <div class="col-sm-4">
                                ...
                                <h2 class="card-inside-title" style="font-weight:bold;">Choose Photo:</h2>
                                <div class="row clearfix">
                                    <div class="col-sm-4">
