            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="alert alert-warning" role="alert">
                        <strong>You are in the process of changing your password, Be careful!!! <a target="_blank" href="#"> See the manual</a>
                        ...
                        <div class="body">
                            <form id="product-form" class="form-horizontal" method="post" action="admin.php?controller=user&action=result" enctype="multipart/form-data" role="form">
                                ...
                                <div class="form-group" style="text-align: center;">
                                    ...
                                    <a class="btn btn-warning waves-effect" href="admin.php?controller=user&action=info&amp;user_id=<?php echo $user_info['id']; ?>">Return</a>
                                </div>
                            </form>
                        </div>
                    </div>
