    ...
    <div class="body_scroll">
        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                ...
                <hr>
                <h2 style="font-weight: bold;">Personal information editing section</h2>
                <div class="col-lg-12">
                    <form id="product-form" class="form-horizontal" method="post" action="admin.php?controller=user&action=edit" enctype="multipart/form-data" role="form">
                        ...
                        <?php if ($login_user['role_id'] == 1) : ?>
                            <h4 class="card-inside-title" style="font-weight:bold;">user name:</h4>
                            <div class="row clearfix">
                                <div class="col-sm-12">
                        ...
                        <?php else : ?>
                            <h4 class="card-inside-title" style="font-weight:bold;">user name: "<?= $user_info['user_username'] ?>"</h4>
                            <input name="username" type="hidden" value="<?php echo $user_info ? $user_info['user_username'] : ''; ?>" class="form-control" />
                        <?php endif; ?>
                        <h4 class="card-inside-title" style="font-weight:bold;">User name and surname:</h4>
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <input name="name" type="text" maxlength="250" value="<?php echo $user_info ? $user_info['user_name'] : ''; ?>" class="form-control" id="name" placeholder="user name and surname..." required="" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <input name="email" type="email" maxlength="250" value="<?php echo $user_info ? $user_info['user_email'] : ''; ?>" class="form-control" id="color" placeholder="Enter your email..." required="" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <input name="address" type="text" maxlength="250" value="<?php echo $user_info ? $user_info['user_address'] : ''; ?>" class="form-control" id="material" placeholder="User address..." required="" />
                                </div>
                            </div>
                        </div>
                        ...
                        <h4 class="card-inside-title" style="font-weight:bold;">Choose a New Image:</h4>
                        <div class="row clearfix">
                            <div class="col-sm-4">
