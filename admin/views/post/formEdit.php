            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="alert alert-warning" role="alert">
                        <strong><?php echo $post ? 'Warning: </strong> You are on the post\'s edit page "' . $post['post_title'] . '", Be careful!!! <a target="_blank" href="#"> See the manual</a>' : 'Warning: </strong> You are on the create a new page, Be careful!!! <a target="_blank" href="#"> See the manual</a>'; ?>
                                ...
                                <div class="row clearfix">
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <input name="title" type="text" value="<?php echo $post ? $post['post_title'] : ''; ?>" class="form-control" id="name" placeholder="Enter the post title..." required="" />
                                                </div>
                                            </div>
                                        </div>
                                        <h2 class="card-inside-title" style="font-weight:bold;">Slug (Link to article):</h2>
                                        <div class="row clearfix">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <input name="slug" type="text" value="<?php echo $post ? $post['post_slug'] : ''; ?>" class="form-control" id="slug" placeholder="Enter the article link..." required="" />
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-sm-4">
                                            ...
                                            <div class="row clearfix">
                                                <div>
                                                    <div>
                                                        ...
                                                        <?php } else echo '<h6>No profile photo yet</h6>'; ?>
                                                    </div>
                                                </div>
                                            </div>
                                        <?php endif; ?>
                                        <hr>
                                        <h2 style="text-align: center;">Change new photo</h2>
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <input name="totalview" type="text" value="<?php echo $post ? $post['totalView'] : ''; ?>" class="form-control" id="totalview" placeholder="Views..." />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group" style="text-align: center;">
                                            ...
                                            <button class="btn btn-primary waves-effect" type="submit"><?php echo $post ? 'Update the post' : 'Add new post'; ?></button>
                                            <a class="btn btn-warning waves-effect" href="admin.php?controller=post">Return</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
