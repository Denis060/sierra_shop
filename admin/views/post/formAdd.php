            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="alert alert-warning" role="alert">
                        <strong><?php echo 'Warning: </strong> You are on the Add New Posts page, Be careful!!! <a target="_blank" href="#"> See the manual</a>'; ?>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <input name="totalview" type="text" value="<?php echo $post ? $post['totalView'] : 0; ?>" class="form-control" id="totalview" placeholder="Views..." />
                                                </div>
                                            </div>
                                        </div>
