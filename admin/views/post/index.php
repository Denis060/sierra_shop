                            ...
                            <table class="table table-hover c_table theme-color">
                                ...
                                <tbody>
                                    ...
                                    foreach ($posts as $post) : ?>
                                        <tr>
                                            <td>
                                                <strong><a style="color: #000;" href="admin.php?controller=post&action=edit&post_id=<?= $post['id'] ?>"><?= $post['post_title'] ?></a></strong>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <a title="Edit" class="btn btn-warning btn-icon btn-icon-mini btn-round" href="admin.php?controller=post&action=edit&post_id=<?= $post['id'] ?>"> <i class="zmdi zmdi-edit"></i> </a>
                                                ...
                                                <?php else : ?>
                                                    <a title="Public" class="btn btn-success btn-round" href="admin.php?controller=post&action=public&post_id=<?= $post['id'] ?>"> <i class="zmdi zmdi-sun"></i> Public</a>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
