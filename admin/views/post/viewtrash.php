                                    ...
                                    foreach ($posts as $post) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a title="Restore" class="btn btn-success btn-round" href="admin.php?controller=post&action=restore&post_id=<?= $post['id'] ?>"> <i class="zmdi zmdi-refresh-sync"></i> Rehibilitate</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
