        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    <h2>Feedback sheet information</h2>
                    <ul class="breadcrumb">
            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                <div class="table-responsive">
                                    ...
                                    <h3 style="font-weight: bold;text-align: center;">Total Money Earn : <?php echo number_format($order_total, 0, ',', '.'); ?> <?=CURRENCY?></h3>
                    ...
                    <?php elseif ($feedback['product_id'] <> 0) :  ?>
                        <div class="card">
                            <div class="header">
                                <h2><strong>Product has been selected for feedback</strong></h2>
                                <ul class="header-dropdown">
                                    <li class="dropdown"> <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> <i class="zmdi zmdi-more"></i> </a>
                                        <ul class="dropdown-menu dropdown-menu-right">
                                            <li><a href="javascript:void(0);"><?=LEAVE_COMMENT?></a></li>
                                            <li><a href="javascript:void(0);"><?=LEAVE_FEEDBACK?></a></li>
                                            <li><a href="admin.php?controller=order"><?=ORDER_MANAGEMENT?></a></li>
                                        </ul>
                                    </li>
                                    <li class="remove">
                                        <a role="button" class="boxs-close"><i class="zmdi zmdi-close"></i></a>
                ...
                <hr>
                <h2 style="font-weight: bold;"><?=FEEDBACK_SECTION?></h2>
                <div class="col-lg-12">
                    <h4 class="card-inside-title" style="font-weight:bold;"><?=FIRST_AND_LAST_NAME?>:</h4>
                    <div class="row clearfix">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <input name="name" disabled type="text" value="<?php echo $feedback ? $feedback['name'] : ''; ?>" class="form-control" id="name" placeholder="<?=FIRST_NAME_AND_SRNAME?>..." required="" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row clearfix">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <input name="email" disabled type="text" value="<?php echo $feedback ? $feedback['email'] : ''; ?>" class="form-control" id="color" placeholder="<?=ENTER_YOUR_EMAIL?>..." required="" />
                            </div>
                        </div>
                    </div>
                    <h4 class="card-inside-title" style="font-weight:bold;"><?=PHONE_NUMBER?>:</h4>
                    <div class="row clearfix">
                        <div class="col-sm-12">
                            <div class="form-group">
                    ...
                    <div class="row clearfix">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <textarea name="subject" disabled type="text" class="form-control" id="totalview" required placeholder="<?=FEEDBACK_CONTENT?>..."><?php echo $feedback ? $feedback['subject'] : ''; ?></textarea>
                            </div>
                        </div>
                    </div>
                    <br><br>
                    <div class="form-group" style="text-align: center;">
                        ...
                        <a class="btn btn-primary waves-effect" href="admin.php?controller=feedback&action=edit&feedback_id=<?= $feedback['id'] ?>"><?=EDIT_FEEDBACK?></a>
                        <a class="btn btn-warning waves-effect" href="admin.php?controller=feedback">Trở về</a>
                        <a class="btn btn-success waves-effect" href="admin.php?controller=feedback&action=reply&feedback_id=<?= $feedback['id'] ?>"><?=REPLY_TO_FEEDBACK?></a>
                    </div>
                </div>
            </div>
        </div>
