    ...
    <div class="body_scroll">
        <div class="block-header">
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    <h2>Edit Feedback Sheet Info </h2>
                    <ul class="breadcrumb">
        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                        ...
                        <div class="card">
                                ...
                                <ul class="header-dropdown">
                                    <li class="dropdown"> <a href="javascript:vorder_id(0);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> <i class="zmdi zmdi-more"></i> </a>
                                        <ul class="dropdown-menu dropdown-menu-right slideUp">
                                            ...
                                            <li><a href="admin.php?controller=feedback&action=order">Feedback about orders</a></li>
                                            <li><a href="admin.php?controller=feedback&action=other">More feedback</a></li>
                                        </ul>
                                    </li>
                                    <li class="remove">
                            ...
                            <div class="body">
                                <div class="table-responsive">
                                    ...
                                    <h3 style="font-weight: bold;text-align: center;">Total money Earn : <?php echo number_format($order_total, 0, ',', '.'); ?> VNĐ</h3>
                                ...
                                <ul class="header-dropdown">
                                    <li class="dropdown"> <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> <i class="zmdi zmdi-more"></i> </a>
                                        <ul class="dropdown-menu dropdown-menu-right">
                                            <li><a href="javascript:void(0);">Q/Lyric comment</a></li>
                                            <li><a href="javascript:void(0);">Q/Leave feedback</a></li>
                ...
                <hr>
                <h2 style="font-weight: bold;">Editing section</h2>
                <div class="col-lg-12">
                    <form id="product-form" class="form-horizontal" method="post" action="admin.php?controller=feedback&action=edit" enctype="multipart/form-data" role="form">
                        ...
                        <h4 class="card-inside-title" style="font-weight:bold;">First and last name:</h4>
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <input name="name" type="text" maxlength="250" value="<?php echo $feedback ? $feedback['name'] : ''; ?>" class="form-control" id="name" placeholder="Enter First and last name..." required="" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <input name="email" type="email" maxlength="250" value="<?php echo $feedback ? $feedback['email'] : ''; ?>" class="form-control" id="color" placeholder="Enter your email..." required="" />
                                </div>
                            </div>
                        </div>
                        <h4 class="card-inside-title" style="font-weight:bold;">Enter your phone number:</h4>
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                <div class="form-group">
                        ...
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <textarea name="subject" type="text" class="form-control" id="totalview" required placeholder="Feedback content..."><?php echo $feedback ? $feedback['subject'] : ''; ?></textarea>
                                </div>
                            </div>
                        </div>
                        <h4>Status:</h4>
                        ...
                        <div class="form-group" style="text-align: center;">
                            <button class="btn btn-primary waves-effect" type="submit">Update feedback again</button>
