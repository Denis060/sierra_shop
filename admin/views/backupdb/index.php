            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="alert alert-warning" role="alert">
                        <strong>You are on the page "Backup Database CSDL", Be careful!!! <a target="_blank" href="#"> See the manual</a>
                    ...
                    <div class="card">
                        <div class="body">
                            <form id="product-form" class="form-horizontal" method="post" action="admin.php?controller=backupdb" enctype="multipart/form-data" role="form">
                                <h1 style="text-align: center; font-weight:bold;">You are currently on the site to take a backup of the database of this website</h1>
                                <hr>
                                ...
                                <input type="text" hidden name="back_u_P_Data_base">
                                    <button class="btn btn-primary waves-effect" type="submit">Yes! Start creating a Backup</button>
