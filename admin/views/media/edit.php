            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="alert alert-warning" role="alert">
                        <strong>You are in the image editing page, <?=BECAREFUL?>!!! <a target="_blank" href="#"> <?=SEE_THE_MANUAL?></a>
                        ...
                        <div class="body">
                            <form id="product-form" class="form-horizontal" method="post" action="admin.php?controller=media&action=edit" enctype="multipart/form-data" role="form">
                                ...
                                <div class="form-group" style="text-align: center;">
                                    <button class="btn btn-primary waves-effect" type="submit">Confirm Photo Update</button>
