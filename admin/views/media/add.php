            ...
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><?=ADD_NEW_PHOTO?></li>
                    </ul>
                </div>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="alert alert-warning" role="alert">
                        <strong>You are on the page to upload a new image, <?=BECAREFUL?>!!! <a target="_blank" href="#"> <?=SEE_THE_MANUAL?></a>
                    ...
                    <div class="card">
                        <div class="body">
                            <form id="product-form" class="form-horizontal" method="post" action="admin.php?controller=media&action=add" enctype="multipart/form-data" role="form">
                                ...
                                <h2 class="card-inside-title" style="font-weight:bold;"><?=IMAGE_NAME?>:</h2>
                                <div class="row clearfix">
                                    <div class="col-sm-12">
                                ...
                                <h2 class="card-inside-title" style="font-weight:bold;">Select a new product creation date (required):</h2>
                                <div class="row clearfix">
                                    <div class="col-sm-4">
                                ...
                                <div class="form-group" style="text-align: center;">
                                    ...
                                    <a class="btn btn-warning waves-effect" href="admin.php?controller=media"><?=RTN?></a>
                                </div>
                            </form>
                        </div>
                    </div>
