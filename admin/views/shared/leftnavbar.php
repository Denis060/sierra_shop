...
<aside id="leftsidebar" class="sidebar" >
        <div class="navbar-brand">
            ...
            <a href="admin.php"><img src="admin/themes/images/logo.svg" width="25" alt="Aero"><span class="m-l-10"><?=SITE_NAME?></span></a>
        </div>
        <div class="menu">
            <ul class="menu-list" style="overflow-y: scroll !important;width: auto;height: calc(100vh - 65px);">
                <li>
                    <div class="user-info">
                ...
                <li class="open"><a href="<?= PATH_URL ?>home" target="_blank"><i class="zmdi zmdi-home"></i><span>Back to SHOP</span></a></li>
                <li <?php if (isset($home_nav)) echo $home_nav; ?>><a href="admin.php"><i class="zmdi zmdi-view-dashboard"></i><span>Dashboard</span></a></li>
                ...
                <li <?php if (isset($your_Purchase)) echo $your_Purchase; ?>><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-assignment"></i><span>Your Purchase</span></a>
                    <ul class="ml-menu">
                        ...
                        <li><a href="admin.php?controller=purchase&action=confirmed">Veriied Purchase</a></li>
                        <li><a href="admin.php?controller=purchase&action=delivery">Orders on Delivering</a></li>
                        <li><a href="admin.php?controller=purchase&action=receied">Orders Delivered</a></li>
                        <li><a href="admin.php?controller=purchase&action=cancelled">Orders Cancelled</a></li>
                    </ul>
                </li>
                <?php if ($user_info_nav['role_id'] != 0) :
                    if ($user_info_nav['role_id'] == 1) : ?>
                        <li <?php if (isset($nav_category)) echo $nav_category; ?>> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-folder"></i><span>Manage Categories</span></a>
                            <ul class="ml-menu">
                                <li><a href="admin.php?controller=shop">Category Group</a></li>
                                <li><a href="admin.php?controller=shop&amp;action=edit">Add New Category</a></li>
                                <li><a href="admin.php?controller=category">Subcategory</a></li>
                        ...
                        <li <?php if (isset($backupdb)) echo $backupdb; ?>><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-dns"></i><span>Backup</span></a>
                            <ul class="ml-menu">
                                <li><a href="admin.php?controller=backupdb">Database Backup</a></li>
                                <li><a href="admin.php?controller=backupdb&action=list">List Backup Database</a></li>
                            </ul>
                        </li>
                    ...
                    <li <?php if (isset($nav_page)) echo $nav_page; ?>><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-blogger"></i><span>Blog -> Page</span></a>
                        <ul class="ml-menu">
                            ...
                            <li><a href="admin.php?controller=page&action=viewtrash">Garbage Can</a></li>
                    ...
                    <li <?php if (isset($nav_post)) echo $nav_post; ?>><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-blogger"></i><span>Blog -> Post</span></a>
                        <ul class="ml-menu">
                            <li><a href="admin.php?controller=post">All Posts</a></li>
                            <li><a href="admin.php?controller=post&action=viewtrash">Garbage Can</a></li>
                    ...
                    <li <?php if (isset($nav_product)) echo $nav_product; ?>> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-collection-text"></i><span>Product Mangement</span></a>
                        <ul class="ml-menu">
                            <li><a href="admin.php?controller=product">List of Products</a></li>
                            <li><a href="admin.php?controller=product&action=update">New Product Update</a></li>
                            ...
                            <li><a href="admin.php?controller=product&amp;action=edit">Add New Products</a></li>
                        </ul>
                    </li>
                    <li <?php if (isset($nav_order)) echo $nav_order; ?>><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-shopping-cart"></i><span>Orders Management</span></a>
                        <ul class="ml-menu">
                            <li><a href="admin.php?controller=order">List of All Orders</a></li>
                            <li><a href="admin.php?controller=order&amp;action=order-noprocess">Unprocessed Orders</a></li>
                            <li><a href="admin.php?controller=order&amp;action=order-inprocess">Processing Orders</a></li>
                            <li><a href="admin.php?controller=order&amp;action=order-complete">Procesed Orders</a></li>
