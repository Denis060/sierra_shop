            ...
            <div class="row">
                <div class="col-lg-4 col-sm-12">
                    <form class="card auth_form" action="admin.php?controller=home&action=login" role="form" method="post">
                        <div class="header">
                            <img class="logo" src="admin/themes/images/logo.jpeg" alt="">
                            <h5>Log in</h5>
                        </div>
                        <div class="body">
                            ...
                            <div class="signin_with mt-3">
                                <p class="mb-0"><a href="index.php?controller=forgot-password"><i class="zmdi zmdi-lock"></i> Forgot password ?</a></a></p>
                                <p class="mb-0">Don't Have Accont <a href="register.php">Register Here</a></p>
                    ...
                    <div class="copyright text-center">
                        ...
                        <span>Design: <a href="https://distech.com/" target="_blank">DISTECH</a></span><span> - Developed by <a href="https://DISTECH.com" target="_blank">DISTECH</a></span>
                    </div>
                </div>
