        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="header">
                            <h2><strong>Data access</strong> "All orders" </h2>
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                ...
                                <h3 style="font-weight: bold;text-align: center;">Total Money Earn : <?php echo CURRENCY." ". number_format($order_total, 0, ',', ','); ?></h3>
