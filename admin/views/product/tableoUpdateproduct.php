...
<div class="row clearfix">
    <div class="col-lg-12">
        <div class="card">
            <div class="header">
                <h2><strong><?=DATA_ACCESS?></strong> <?=PRODUCT_JUST_UPDATED?> </h2>

                <ul class="header-dropdown">
                    <li class="dropdown"> <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> <i class="zmdi zmdi-more"></i> </a>
                        <ul class="dropdown-menu dropdown-menu-right slideUp">
                            <li><a href="admin.php?controller=product&action=edit"><?=ADD_NEW_PRODUCT?></a></li>
                            <li><a href="admin.php?controller=product&action=newproduct"><?=NEW_PRODUCT?></a></li>
                            <li><a href="admin.php?controller=product&action=saleproduct"><?=DISCOUNT_PRODUCTS?></a></li>
                            <li><a href="admin.php?controller=product&action=hotproduct"><?FEATURED_PRODUCT?></a></li>
                        </ul>
                    </li>
                    <li class="remove">
