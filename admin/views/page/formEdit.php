            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="alert alert-warning" role="alert">
                        <strong><?php echo $post ? 'Warning: </strong> You are on the page\'s edit page "' . $post['post_title'] . '", Be careful!!! <a target="_blank" href="#"> See the manual</a>' : 'Warning: </strong> You are on the create a new page, Be careful!!! <a target="_blank" href="#"> See the manual</a>'; ?>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <div class="form-group" style="text-align: center;">
                                            ...
                                            <button class="btn btn-primary waves-effect" type="submit"><?php echo $post ? 'Update page again' : 'Add new page'; ?></button>
                                            <a class="btn btn-warning waves-effect" href="admin.php?controller=page"><?=RTN?></a>
                                        </div>
                                    </div>
                                </div>
                            </form>
