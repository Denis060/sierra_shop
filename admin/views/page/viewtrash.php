            ...
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Garbage can</li>
                    </ul>
                                ...
                                <tbody>
                                    ...
                                    foreach ($pages as $page) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a onclick="return confirm('Are you sure to delete?')" title="Delete" class="btn btn-danger btn-round" href="admin.php?controller=page&action=delete&page_id=<?= $page['id'] ?>"> <i class="zmdi zmdi-delete"></i> Permanently deleted</a>
                                                <a title="Restore" class="btn btn-success btn-round" href="admin.php?controller=page&action=restore&post_id=<?= $page['id'] ?>"> <i class="zmdi zmdi-refresh-sync"></i> Rehibilitate</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
