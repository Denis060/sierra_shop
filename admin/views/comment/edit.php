                ...
                <div class="col-lg-12">
                    ...
                    <form id="product-form" class="form-horizontal" method="post" action="admin.php?controller=comment&action=edit" enctype="multipart/form-data" role="form">
                        ...
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <input name="name" type="text" value="<?php echo $comment ? $comment['author'] : ''; ?>" class="form-control" id="name" placeholder="real name and surname..." required="" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <input name="email" type="email" maxlength="100" value="<?php echo $comment ? $comment['email'] : ''; ?>" class="form-control" id="color" placeholder="Enter your email..." required="" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <textarea name="subject" type="text" class="form-control" id="ckeditor" required placeholder="Feedback content..."><?php echo $comment ? $comment['content'] : ''; ?></textarea>
                                </div>
                            </div>
                        </div>
                        <h4>Status:</h4>
                        ...
                        <div class="form-group" style="text-align: center;">
                            ...
                            <a class="btn btn-warning waves-effect" href="admin.php?controller=comment">Return</a>
                        </div>
                    </form>
                </div>
            </div>
