...
if (mysqli_num_rows(mysqli_query($linkconnectDB, "SELECT id FROM menu_footers WHERE id='$menufooter_id'")) == 0) {
    echo "<div style='padding-top: 200' class='container'><div class='alert alert-danger' style='text-align: center;'><strong>NO!</strong> This field does not exist. <a href='javascript: history.go(-1)'>Come back</a></div></div>";
    require('admin/views/header-footer/result.php');
    exit;
}
$title = 'Fix menu link footer website';
