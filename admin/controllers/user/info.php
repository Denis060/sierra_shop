...
if (mysqli_num_rows(mysqli_query($linkconnectDB, "SELECT id FROM users WHERE id='$user_id'")) == 0) {
    echo "<div style='padding-top: 200' class='container'><div class='alert alert-danger' style='text-align: center;'><strong>NO!</strong> Person This user does not exist <a href='javascript: history.go(-1)'>Back</a></div></div>";
