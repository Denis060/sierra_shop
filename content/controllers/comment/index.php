...
if (!empty($_POST)) {
    ...
    echo "<div class='alert alert-success'><strong>Done!</strong> You have successfully recorded your comment !! <br>Please <a href='javascript: history.go( -1)'>Back to product</a> or <a href='index.php'>Go to home page</a></div>";
}
