	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div class="row">
					<div class="col-md-12">
						<h2><a href="type/2-san-pham-moi"><strong>New </strong>Products</a></h2>
					</div>
							...
							<li class="col-sm-3 col-xs-12 product">
								...
								<span class="product-thumb-info">
									<form action="cart/add/<?php echo $new_product['id']; ?>" method="post">
										...
										<a class="add-to-cart-product"><button type="submit" href="cart/add/<?php echo $new_product['id']; ?>"><i class="fa fa-shopping-cart"></i> Add to cart</button></a>
									</form>
										...
										<a href="product/<?php echo $new_product['id']; ?>-<?php echo $new_product['slug']; ?>/">
											...
											<span class="price">
												<?php if ($new_product['saleoff'] != 0) { ?>
													...
													<ins title="<?php echo $new_product['product_name']; ?>"><span class="amount"><?php echo number_format(($new_product['product_price']) - (($new_product['product_price'] * $new_product['percentoff']) / 100), 0, ',', '.')." ".CURRENCY; ?></span></ins>
												<?php } else { ?>
													<ins><span class="amount"><?php echo CURRENCY." ".number_format($new_product['product_price'], 0, ',', '.');  ?></span></ins>
												<?php } ?>
											</span>
										</a>
									</span>
