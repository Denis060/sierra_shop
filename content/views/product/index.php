    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-9">
                    ...
                    <div class="col-md-6">
                        <div class="summary entry-summary">
                            ...
                            <p class="price">
                                ...
                                <del><span
                                        class="amount"><?php echo CURRENCY." ".number_format($product['product_price'], 0, ',', ',');  ?></span></del>
                                <ins><span
                                        class="amount"><?php echo CURRENCY." ".number_format(($product['product_price']) - (($product['product_price'] * $product['percentoff']) / 100), 0, ',', ','); ?>
                                    </span></ins>
                                <?php } else { ?>
                                <ins><span
                                        class="amount"><?php echo CURRENCY." ".number_format($product['product_price'], 0, ',', ',');  ?>
                                    </span></ins>
                                <?php } ?>
                            </p>
                            ...
                            <form enctype="multipart/form-data" method="post" class="cart"
                                ...
                                <div class="quantity">
                                    <input type="number" class="input-text qty text" title="customer's feedback"
                            ...
                            <div class="product_meta">
                                <span class="posted_in">subcategory: <a rel="tag"
                                        href="category/<?php echo $subcategories['id'] . '-' . $subcategories['slug']; ?>"><?php echo $breadCrumb ?></a></span>
                            </div>
                            <hr class="tall">
                            <div class="feedback">
                                <a href="index.php?controller=feedback&action=index&product_id=<?= $product['id'] ?>">
                                Click here</b></a> to submit feedback on this product.
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="tabs tabs-product">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="#productDetail" data-toggle="tab">Product details</a>
                                </li>
                                <li><a href="#productInfo" data-toggle="tab">Other information</a></li>
                                <li><a href="#productReviews" data-toggle="tab">(<?= $comments_total ?>) Comments</a></li>
                            </ul>
                                            ...
                                            <form action="index.php?controller=comment" id="submitReview" method="post">
                                                ...
                                                <div class="row">
                                                    <div class="form-group">
                                                        <div class="col-md-12">
                                                            <?php if (isset($user_nav)) : ?>
                                                                <label>You are logged in with the account <strong><?= $user_login['user_name'] ?></strong>. You want <a href="admin.php?controller=home&action=logout">log out</a> ?</label>
                                                            <?php else : ?>
                                                                <label>Do you want <strong><a href="admin.php?controller=home&action=login">log in</a></strong> to comment with your account.!</label>
                                                            <?php endif; ?>
                                                            <textarea maxlength="5000" data-msg-required="Please enter your message." rows="10" class="form-control" name="content" id="message" placeholder="Enter your comment or message or feedback about the product ....."></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <?php if (isset($user_nav)) : ?>
                                                            <label>Bạn đang đăng nhập với tài khoản
                                                                <strong><?= $user_login['user_name'] ?></strong>. You want
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h2><strong>Related Category</strong> Products</h2>
                    </div>
                    ...
                    <ul class="products product-thumb-info-list">
                        ...
                        <h3 class="col-sm-12">There are no related products.</h3>
                        <?php endif; ?>
                                ...
                                <span class="product-thumb-info-content">
                                    <a
                                        ...
                                        <span class="price">
                                            <?php if ($related_product['saleoff'] != 0) { ?>
                                            <del><span
                                                    class="amount"><?php echo CURRENCY." ".number_format($related_product['product_price'], 0, ',', ',');  ?></span></del>
                                            <ins><span
                                                    class="amount"><?php echo  CURRENCY." ".number_format(($related_product['product_price']) - (($related_product['product_price'] * $related_product['percentoff']) / 100), 0, ',', ','); ?>
                                                    </span></ins>
                                            <?php } else { ?>
                                            <ins><span
                                                    class="amount"><?php echo  CURRENCY." ".number_format($related_product['product_price'], 0, ',', ',');  ?>
                                                    </span></ins>
                                            <?php } ?>
                                        </span>
                                    </a>
