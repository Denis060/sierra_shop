            ...
            <div class="col-md-9">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <p>Display <?php if ($total_rows >= 9) echo '1–9 trong '; ?><?php echo $total_rows; ?> result.</p>
                    </div>
                </div>
                <div class="row">
                    <div>
                    ...
                    <div><?php if (empty($products)) { ?>
                            <h3 class="col-sm-12">No matches were found for the above keywords.</h3>
                        <?php } else { ?><h3 class="col-sm-12">There is a total <?php echo $total_rows ?> Results matching the word
                            lock up "<?php echo $keyword ?>".</h3><?php } ?></div>
                    <hr class="tall">
                                        ...
                                        <h4 title="<?php echo $product['product_name']; ?>"><?php if (strlen($product['product_name']) > 50) echo substr($product['product_name'], 0, 57) . '...';
                                            ...
                                            <span class="price">
                                                <?php if ($product['saleoff'] != 0) { ?>
                                                    ...
                                                    <ins><span class="amount"><?php echo number_format(($product['product_price']) - (($product['product_price'] * $product['percentoff']) / 100), 0, ',', '.')." ".CURRENCY; ?></span></ins>
                                                <?php } else { ?>
                                                    <ins><span class="amount"><?php echo number_format($product['product_price'], 0, ',', '.')." ".CURRENCY;  ?></span></ins>
                                                <?php } ?>
                                            </span>
                                        </a>
                                    </span>
