...
<aside class="sidebar">
    ...
    <?php } ?>
    <hr />
    <h4 style="font-weight: bold;">TOP PRODUCTS</h4>
        ...
        <?php foreach ($product_top as $topview_product) : ?>
            <li>
                ...
                <div class="post-info">
                    ...
                    <div class="post-meta">
                        <?php if ($topview_product['saleoff'] != 0) echo CURRENCY." ". number_format(($topview_product['product_price']) - (($topview_product['product_price'] * $topview_product['percentoff']) / 100), 0, ',', '');
                        else echo CURRENCY." ".number_format($topview_product['product_price'], 0, ',', ','); ?>
                    </div>
                </div>
            </li>
        <?php endforeach; ?>
    ...
    <?php if (isset($get_sidebar_with_only_product)) { ?>
        <h4 style="font-weight: bold;">LATEST PRODUCT</h4>
        <ul class="simple-post-list">
