			...
			<div class="container">
				...
				<nav>
					<ul class="nav nav-pills nav-top">
						<li>
							<a href="<?= $link_about ?>"><i class="fa fa-angle-right"></i>Information</a>
						</li>
						<li>
							<a href="<?= $link_contact ?>"><i class="fa fa-headphones"></i>Contact</a>
						</li>
							...
							<li class="dropdown active">
								...
								<ul class="dropdown-menu">
									...
									<li class="dropdown-submenu">
										<a href="javascript:void(0);">About <?=OWNER?></a>
										<ul class="dropdown-menu">
											<li><a href="<?= $link_contact ?>">Contact</a></li>
											<li><a href="<?= $link_about ?>">Information about the business</a></li>
										</ul>
									</li>
								</ul>
							</li>
																...
																<tr>
																	...
																	<td class="product-name">
																		<a href="product/<?php echo $product_cart['id'] . '-' . slug($product_cart['name']); ?>"><?php echo $product_cart['name'] ?><br><span class="amount"><strong>
																					<?php if ($product_cart['saleoff'] != 0) echo CURRENCY." ".number_format(($product_cart['price']) - (($product_cart['price'] * $product_cart['percent_off']) / 100), 0, ',', '.');
																					else echo CURRENCY." ".number_format($product_cart['price'], 0, ',', '.'); ?>
																					</strong> - Quantity: <?php echo $product_cart['number'] ?> </span></a>
																	</td>
												...
												<div class="row">
													<div class="col-md-6">
														<div class="user-avatar">
															...
															<p><strong><?= $user_login['user_name'] ?></strong><span><?php if ($user_login['role_id'] == 0) echo "Customer";
													...
													<div class="col-md-6">
														<ul class="list-account-options">
															<li><a href="admin.php?controller=user&action=info&user_id=<?= $user_nav ?>">My account</a></li>
