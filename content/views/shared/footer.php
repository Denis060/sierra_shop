...
<footer class="short" id="footer">
    <div class="container">
        <div class="row">
            <div class="col-md-9">
                <h4>Information</h4>
                <p><?= $about_footer ?><a href="<?= $link_about ?>" class="btn-flat btn-xs">see more <i class="fa fa-arrow-right"></i></a></p>
                <hr class="light">
                <div class="row">
                    <div class="col-md-3">
            ...
            <div class="col-md-3">
                ...
                <p class="short">Additional phone number: <?= $phone2 ?></p>
                <ul class="list icons list-unstyled push-top">
                    <li><i class="fa fa-map-marker"></i> <strong>Address:</strong> <?= $address_contact ?></li>
        ...
        <div class="container">
            <div class="row">
                <p>© Copyright <script>
                    ...
                    </script> - Developed by<span><a href="https://DISTECH.com">DISTECH</a></span>.</p>
            </div>
        </div>
    </div>
</footer>
