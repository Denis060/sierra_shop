            ...
            <div class="row">
                <div class="col-md-6 col-md-offset-1">
                    <div class="page-not-found-main">
                        ...
                        <p>We're sorry, but the page you were looking for doesn't exist. <br> We're sorry, but the page you're looking for doesn't exist.</p>                    </div>
                </div>
                <div class="col-md-4">
                <h4>Here are some helpful links</h4>
                     <ul class="nav nav-list primary">
                         <li><a href="<?php echo PATH_URL; ?>home">Homepage</a></li>
                         <li><a href="<?= $link_about ?>">About us</a></li>
