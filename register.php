            ...
            <div class="row">
                <div class="col-lg-4 col-sm-12">
                    <form method="POST" class="card auth_form" action="index.php?controller=register">
                        ...
                        <div class="body">
                            ...
                            <div class="checkbox">
                                ...
                                <label for="remember_me">I read and agree with <a href="javascript:void(0);">Terms of Use</a></label>
                            </div>
                            <button type="submit" class="btn btn-primary btn-block waves-effect waves-light">SIGN UP</button>
                            <div class="signin_with mt-3">
                                <a class="link" href="admin.php">Do you already have an account? Go to "Login"!</a>
                            </div>
                        </div>
                    </form>
                    <div class="copyright text-center">
                        ...
                        <span>Design: <a href="https://distech.com/" target="_blank">DISTECH</a></span><span> - Developed by<a href="https://distech.com" target="_blank">DIS TECH</a></span>
                    </div>
                </div>
